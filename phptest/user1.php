...
//$sql1="select grade1,grade2,grade3,grade4 as aver from grade";
//$query1=mysqli_query($conn,$sql1);
//$sql4="TRUNCATE TABLE grade";
...
//$sql4="select DATE,ID,Height,Weight from grade order by ID desc limit 5";
...
//$Pressure= array("name"=>"Diastolic","data"=>$Diastolic);
